...
export const STACK = [
  {
    label: "Design",
    lead: ["Figma", "Adobe XD", "Canva"],
    rest: ["Auto-layout", "Variables", "Prototyping", "Handoff"],
  },
  {
    label: "Frontend",
    lead: ["React", "Next.js", "TypeScript", "Tailwind CSS"],
    rest: ["React Native", "CSS", "HTML", "Liquid", "Server components"],
  },
  {
    label: "No-code",
    lead: ["Webflow", "Shopify"],
    rest: ["Wix", "CMS modelling", "Interactions", "Editor handover"],
  },
  {
    label: "Backend",
    lead: ["NextAuth", "Vercel", "Postgres", "SQL", "Supabase"],
    rest: ["Server actions", "Edge functions", "Authentication flows"],
  },
  {
    label: "Research",
    lead: ["User journeys", "Personas", "Site mapping", "Content audits"],
    rest: ["Interviews", "Usability testing"],
  },
];
