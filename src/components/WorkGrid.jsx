  ...
  return (
    <button
      ...
      style={{
        ...
        background: hover
          ? "linear-gradient(90deg, transparent, var(--hf-accent-tint), transparent)"
          : "transparent",
      ...
      <div className="container">
        <div className="section-head reveal">
          <div>
            ...
            <h2>My three favourite projects, end-to-end.</h2>
          </div>
          <span className="meta">2024 — 2026 · 03 of 12</span>
        </div>
        <div>
          {CASES.map((e, i) =>
            layout === "compact" ? (
        ...
        >
          The rest live on the shelf. Happy to walk through anything else under
          NDA — drop me a line.
        </p>
      </div>
    </section>
