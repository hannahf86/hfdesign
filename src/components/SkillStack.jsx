  ...
  return (
    <section id="stack" className="section">
      <div className="container">
        ...
        >
          Filled pills are daily drivers. Outlined are tools I've shipped with
          in the last two years. Anything not listed I'd rather learn than fake.
        </p>
      </div>
    </section>
  );
