...
sections:
  ...
  - id: decisions
    num: "03"
    label: decisions
    heading: No red, no streaks, no total unless you ask.
    numbered:
      - Plain-language framing over financial jargon.
      - Every destructive or overdue state written as a sentence, never signalled by colour alone.
